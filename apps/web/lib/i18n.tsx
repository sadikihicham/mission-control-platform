...
const STR: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    a_new: "Nouveau projet", a_theme: "Basculer le thème", a_logout: "Déconnexion", a_sound: "Son des fourmis au travail",
    ...
    tw_sound: "Ambiance sonore", tw_sound_ants: "Fourmis au travail",
    ...
    au_change_title: "Changer le mot de passe", au_change_sub: "Choisissez un nouveau mot de passe pour votre compte.",
    au_change_current: "Mot de passe actuel", au_change_current_ph: "••••••••",
    au_change_new: "Nouveau mot de passe", au_change_new_ph: "Au moins 6 caractères",
    au_change_btn: "Changer le mot de passe", au_change_ok: "Mot de passe mis à jour.",
    close: "Fermer",
  ...
  en: {
    ...
    a_new: "New project", a_theme: "Toggle theme", a_logout: "Sign out", a_sound: "Working-ants sound",
    ...
    tw_sound: "Soundscape", tw_sound_ants: "Working ants",
    ...
    au_change_title: "Change password", au_change_sub: "Choose a new password for your account.",
    au_change_current: "Current password", au_change_current_ph: "••••••••",
    au_change_new: "New password", au_change_new_ph: "At least 6 characters",
    au_change_btn: "Change password", au_change_ok: "Password updated.",
    close: "Close",
  ...
  ar: {
    ...
    a_new: "مشروع جديد", a_theme: "تبديل السمة", a_logout: "تسجيل الخروج", a_sound: "صوت النمل أثناء العمل",
    ...
    tw_sound: "الأجواء الصوتية", tw_sound_ants: "نمل يعمل",
    ...
    au_change_title: "تغيير كلمة المرور", au_change_sub: "اختر كلمة مرور جديدة لحسابك.",
    au_change_current: "كلمة المرور الحالية", au_change_current_ph: "••••••••",
    au_change_new: "كلمة المرور الجديدة", au_change_new_ph: "6 أحرف على الأقل",
    au_change_btn: "تغيير كلمة المرور", au_change_ok: "تم تحديث كلمة المرور.",
    close: "إغلاق",
