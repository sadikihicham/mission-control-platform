...
const STR: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    adm_tab_users: "Utilisateurs", adm_tab_agents: "Identifiants agents",
    adm_email: "Email", adm_password: "Mot de passe (min. 6 caractères)", adm_create_user: "Créer",
    adm_active: "Actif", adm_inactive: "Désactivé", adm_deactivate: "Désactiver", adm_reactivate: "Réactiver",
    adm_deactivate_confirm: "Désactiver {email} ? Il/elle ne pourra plus se connecter.",
    adm_self_guard: "Vous ne pouvez pas vous modifier vous-même ici.",
    adm_enrolled: "Identifiant propre", adm_shared_secret: "Secret partagé",
    adm_revoke: "Révoquer", adm_revoke_confirm: "Révoquer le token de {agent} ? Il devra se ré-enrôler.",
    adm_issued: "Émis le",
  },
  en: {
    ...
    lang: "Language",
    nav_admin: "Administration",
    adm_tab_users: "Users", adm_tab_agents: "Agent credentials",
    adm_email: "Email", adm_password: "Password (min. 6 chars)", adm_create_user: "Create",
    adm_active: "Active", adm_inactive: "Disabled", adm_deactivate: "Disable", adm_reactivate: "Re-enable",
    adm_deactivate_confirm: "Disable {email}? They won't be able to sign in anymore.",
    adm_self_guard: "You can't edit yourself here.",
    adm_enrolled: "Own credential", adm_shared_secret: "Shared secret",
    adm_revoke: "Revoke", adm_revoke_confirm: "Revoke {agent}'s token? It will need to re-enroll.",
    adm_issued: "Issued",
  },
  ar: {
    ...
    lang: "اللغة",
    nav_admin: "الإدارة",
    adm_tab_users: "المستخدمون", adm_tab_agents: "بيانات اعتماد الوكلاء",
    adm_email: "البريد الإلكتروني", adm_password: "كلمة المرور (6 أحرف على الأقل)", adm_create_user: "إنشاء",
    adm_active: "نشِط", adm_inactive: "معطّل", adm_deactivate: "تعطيل", adm_reactivate: "إعادة تفعيل",
    adm_deactivate_confirm: "تعطيل {email}؟ لن يتمكن من تسجيل الدخول بعد الآن.",
    adm_self_guard: "لا يمكنك تعديل نفسك هنا.",
    adm_enrolled: "بيانات اعتماد خاصة", adm_shared_secret: "سرّ مشترك",
    adm_revoke: "إلغاء", adm_revoke_confirm: "إلغاء رمز {agent}؟ سيحتاج لإعادة التسجيل.",
    adm_issued: "صدر في",
  },
};
